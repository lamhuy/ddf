 ...
 */
public interface IndexQueryResponse extends Response<Request> {
  ...
  /**
   * Get the list of index string of the associated {@link Request}
   *
   * @return the index id
   */
   ...
   * IndexQueryResponse}. <b>Must not be null.</b>
   *
